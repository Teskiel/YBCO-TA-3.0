# -*- coding: utf-8 -*-
"""
Lake Shore Model 335 Temperature Controller Driver (standalone copy)
====================================================================
从 `YBCO_TA/Auto_Sweep/lakeshore_control.py` 拷贝的自包含版本，供
noisesweep 的 standalone 后端使用。不依赖 autosweep 的 `config.py`
（原文件底部 334 行起的鸭子类型 helper 已被剔除）。
...
稳定等待逻辑（wait_for_stability）在 backends.py，与后端实现无关。
"""
