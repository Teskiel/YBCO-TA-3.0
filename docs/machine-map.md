...
| 代号 | 显示名 | 角色 | 主机名 | 提交数 |
|---|---|---|---|---|
| `pc-teski` | 个人开发机（本机） | dev | DESKTOP-FJA4R3U | 6 |
...
| 提交 | 日期 | 作者 | 摘要 | 归属依据 |
|---|---|---|---|---|
| `26039dc` | 2026-09-13 | Teskiel | test(sync): 守护测试改为只扫代码与配置，文档按整段判断 | 提交 trailer |
| `670eac8` | 2026-09-13 | Teskiel | docs(multi-machine): 区分沙箱下 commit 与 push 两种失败，并给出 plumbing 绕行 | 提交 trailer |
| `8821289` | 2026-09-13 | Teskiel | chore(release): v3.1.1 多机同步与版本溯源框架 | 提交 trailer |
| `6a48925` | 2026-09-13 | Teskiel | feat(sync): 多机同步与版本溯源框架，并清除库内机器专属绝对路径 | 提交 trailer |
...
| 置信度 | 含义 | 提交数 |
|---|---|---|
| high | 提交自带 Machine: trailer，直接可信 | 5 |
